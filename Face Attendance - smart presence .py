...
def selesai3():
    intructions.config(text="Presensi Telah Dilakukan")
def rekamDataWajah():
    wajahDir = 'datawajah'
...
def absensiWajah():
    ...
    while True:
        ...
        cv2.imshow('PRESENSI WAJAH - TEKAN Q UNTUK SIMPAN', frame)
...
# judul
judul = tk.Label(root, text="Face Attendance - Smart Presence", font=("Roboto",32),bg="#272643", fg="white")
canvas.create_window(350, 80, window=judul)
#kelompok
kel = tk.Label(root, text="Kelompok 9", font=("Times New Roman",13), bg="black",fg="white")
canvas.create_window(360, 20, window=kel)
# for entry data nama
...
intructions = tk.Label(root, text="Selamat Datang", font=("Roboto",15,"italic"),fg="white",bg="black")
canvas.create_window(370, 300, window=intructions)
Rekam_text = tk.StringVar()
Rekam_btn = tk.Button(root, textvariable=Rekam_text, font="Roboto", bg="#ff0000", fg="white", height=1, width=15,command=rekamDataWajah)
Rekam_text.set("Ambil Gambar")
Rekam_btn.grid(column=0, row=7)

# tombol untuk training wajah
Rekam_text1 = tk.StringVar()
Rekam_btn1 = tk.Button(root, textvariable=Rekam_text1, font="Roboto", bg="#ff0000", fg="white", height=1, width=15,command=trainingWajah)
Rekam_text1.set("Training")
Rekam_btn1.grid(column=1, row=7)

# tombol presensi dengan wajah
Rekam_text2 = tk.StringVar()
Rekam_btn2 = tk.Button(root, textvariable=Rekam_text2, font="Roboto", bg="#ff0000", fg="white", height=1, width=20, command=absensiWajah)
Rekam_text2.set("presensi otomatis")
